...
function Home({ download, recentGames, onOpenLibrary, onOpenDownloads }: { download: DownloadActivity | null; recentGames: RecentGame[]; onOpenLibrary: () => void; onOpenDownloads: () => void }) {
