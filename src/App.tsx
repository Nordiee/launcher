...
function Home({ download, playtimeByGame, queuedTransfers, recentGames, onOpenLibrary, onOpenDownloads }: { download: DownloadActivity | null; playtimeByGame: PlaytimeByGame; queuedTransfers: QueuedTransfer[]; recentGames: RecentGame[]; onOpenLibrary: () => void; onOpenDownloads: () => void }) {
