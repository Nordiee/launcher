...
function Library({ accessToken, onDownload, onNotify, onGameLaunched, runningGameIds }: { accessToken: string; onDownload: (download: DownloadActivity | null) => void; onNotify: (title: string, message: string, kind?: NotificationKind) => void; onGameLaunched: (game: Omit<RecentGame, "lastPlayedAt">) => void; runningGameIds: string[] }) {
