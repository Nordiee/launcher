...
function Settings({ pauseDownloadsWhilePlaying, onPauseDownloadsWhilePlayingChange }: { pauseDownloadsWhilePlaying: boolean; onPauseDownloadsWhilePlayingChange: (enabled: boolean) => void }) {
