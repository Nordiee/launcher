...
function Home({ download, queuedTransfers, recentGames, onOpenLibrary, onOpenDownloads }: { download: DownloadActivity | null; queuedTransfers: QueuedTransfer[]; recentGames: RecentGame[]; onOpenLibrary: () => void; onOpenDownloads: () => void }) {
...
function Settings({ manualUpdateState, onManualUpdateCheck, pauseDownloadsWhilePlaying, onPauseDownloadsWhilePlayingChange }: { manualUpdateState: ManualUpdateState; onManualUpdateCheck: () => void; pauseDownloadsWhilePlaying: boolean; onPauseDownloadsWhilePlayingChange: (enabled: boolean) => void }) {
