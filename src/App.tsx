...
function Settings({ launcherNotificationsEnabled, manualUpdateState, onLauncherNotificationsEnabledChange, onManualUpdateCheck, pauseDownloadsWhilePlaying, onPauseDownloadsWhilePlayingChange }: { launcherNotificationsEnabled: boolean; manualUpdateState: ManualUpdateState; onLauncherNotificationsEnabledChange: (enabled: boolean) => void; onManualUpdateCheck: () => void; pauseDownloadsWhilePlaying: boolean; onPauseDownloadsWhilePlayingChange: (enabled: boolean) => void }) {
