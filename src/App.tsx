...
function Library({ accessToken, favoriteGameIds, recentGames, playtimeByGame, onDownload, onNotify, onFavoriteToggle, onGameLaunched, runningGameIds }: { accessToken: string; favoriteGameIds: string[]; recentGames: RecentGame[]; playtimeByGame: PlaytimeByGame; onDownload: (download: DownloadActivity | null) => void; onNotify: (title: string, message: string, kind?: NotificationKind) => void; onFavoriteToggle: (gameId: string) => void; onGameLaunched: (game: Omit<RecentGame, "lastPlayedAt">) => void; runningGameIds: string[] }) {
